...
//           <h1 className="rd-title">Reputation <span className="rd-span"> Intelligence</span></h1>
  ...
  return (
    <div className="notification-page">
      ...
      <div className="dashboard-header">
        <h1>
          Reputation <span>Intelligence</span>
        </h1>
        <p>Harnessing customer wisdom to refine your botanical craft.</p>
      </div>
      ...
      <div className="middle-grid">
        ...
        <div className="overview-card">
          ...
          <div className="rating-bars">
            ...
            <div className="bar-row">
              <span>5 Star</span>
              <div className="bar">
                <div className="fill fill-89"></div>
              </div>
              <span>89%</span>
            </div>
            ...
            <div className="bar-row">
              <span>4 Star</span>
              <div className="bar">
                <div className="fill fill-10"></div>
              </div>
              <span>10%</span>
            </div>
        ...
        <div className="sentiment-card">
          ...
          <div className="sentiment-boxes">

            <div className="sentiment-item green">
              <h4>62%</h4>
              <p>Positive</p>
            </div>

            <div className="sentiment-item yellow">
              <h4>28%</h4>
              <p>Neutral</p>
            </div>

            <div className="sentiment-item red">
              <h4>10%</h4>
              <p>Negative</p>
            </div>
      ...
      <div className="urgent-section">
        ...
        <div className="urgent-card">
          ...
          <div className="urgent-item">
            <h4>Suspected Fraud</h4>
            <p>Fake review detected on recent product listing...</p>
          </div>

          <div className="urgent-item">
            <h4>Organic Ashwagandha</h4>
            <p>Review mentions delayed response to complaint...</p>
          </div>
        </div>

        <div className="reply-card">
          <div className="urgent-header">
            <h3>Pending Replies Summary</h3>
            <button className="danger">7 Attention</button>
          </div>
          ...
          <button className="reply-btn">Respond Now</button>
        </div>
      ...
      <div className="filters">
        <button>By Rating: All Stars</button>
        <button>Status: All Reviews</button>
      </div>
      ...
      <div className="reviews-section">
        ...
        <div className="review-card">
          ...
          <div className="review-top">
            ...
            <span className="tag">Organic Ashwagandha</span>
          </div>

          <div className="stars">★★★★★</div>

          <p className="review-text">
            “The quality of this Ashwagandha is far superior to anything
            I've tried before. The fine texture and earthy aroma indicate
            its freshness.”
          </p>
          ...
          <div className="reply-box">
            ...
            <textarea placeholder="Craft a thoughtful response..." />
        ...
        <div className="review-card">
          ...
          <div className="review-top">
            ...
            <span className="tag">Turmeric Facial Oil</span>
          </div>

          <div className="stars">★★★★☆</div>

          <p className="review-text">
            “Absolutely love the glow this oil gives! Slightly heavier
            than expected but absorbs well.”
          </p>
