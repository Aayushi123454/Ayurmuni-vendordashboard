...
const VARIANTS = {
    primary:
        "px-4 py-2.5 bg-[#0D614E] text-white shadow-sm hover:bg-[#094c3d] hover:shadow-md active:shadow-sm disabled:opacity-50 disabled:cursor-not-allowed disabled:shadow-none",
    secondary:
    ...
    danger:
        "px-4 py-2.5 bg-[#dc2626] text-white shadow-sm hover:bg-[#b91c1c] hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed",
    ghost:
